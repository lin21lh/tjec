...
@Component("com.wfzcx.fam.common.WFStatusForBaInjectionHandler")
public class WFStatusForBaInjectionHandler implements BussinessDataStatusInjectionHandler {
	@Autowired
	...
	public void inject(String key, String verison, String actiId,
		...
		String sql ="update fa_accounts set wfstatus='"+status+"' where wfid='"+execId+"'";
