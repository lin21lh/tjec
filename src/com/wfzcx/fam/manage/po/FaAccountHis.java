 ...
 */
@Entity
@Table(name = "FA_ACCOUNT_HIS")
@SequenceGenerator(name="SEQ_FA_ACCOUNT_HIS",sequenceName="SEQ_FA_ACCOUNT_HIS")
@GenericGenerator(name = "SEQ_FA_ACCOUNT_HIS", strategy = "native",parameters={@Parameter(name = "sequence", value = "SEQ_FA_ACCOUNT_HIS") })
public class FaAccountHis implements java.io.Serializable {
	...
	@Column(name = "OLDITEMID", nullable = false, precision = 9, scale = 0)
	...
	/** minimal constructor */
	public FaAccountHis(Integer itemid, String accountNumber,
	...
	/** full constructor */
	public FaAccountHis(Integer itemid, String elementcode,
	...
	// Property accessors
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SEQ_FA_ACCOUNT_HIS")
