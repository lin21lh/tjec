...
/**
 * @ClassName: Probaseinfo
 * @Description: 流程过程实体bean
 * @author MyEclipse Persistence Tools
 * @date 2016年8月11日 下午3:10:29
 * @version V1.0
 */
@Entity
@Table(name = "PUB_PROBASEINFO" )
public class Probaseinfo implements java.io.Serializable {
	...
	/** full constructor */
	public Probaseinfo(String id, String processid, String protype,
