...
//private:
function bldStr(ctlType, id, para, cookies)
{
 //!!!!组件版本号，升级后须修改!!!
 var ctlver = '1.0.75.2';
 ...
 str += '<param Name="Cookie" Value="' +cookies + '">';
...
function insertReport(id, para, cookies)		{ document.write( bldStr("LuxForm",	 id, para, cookies) ) }
