//请求路径
var urls = {
	addCommitUrl:"CbiWebController_add.do",
	detailUrl:"CbiWebController_detail.do" 
};
		...
		if (r) {
			$("#xzfyReqForm").form("submit", {
				...
				success:function(result) {
					...
					if (result.success) {
						 window.location.href = urls.detailUrl + "?caseid=" + result.title; 
					} else {
