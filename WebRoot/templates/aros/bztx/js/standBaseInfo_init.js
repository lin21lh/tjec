...
$(function() {
	...
	comboboxFuncByCondFilter(menuid, "sysType", "BZTX_TXLB", "code", "name");
	var icons = {iconCls:"icon-clear"};
	$("#standardName").textbox("addClearBtn", icons);
	$("#sysType").textbox("addClearBtn", icons);
	$("#starttime").textbox("addClearBtn", icons);
	$("#endtime").textbox("addClearBtn", icons);
	$('#bztxPanel').panel('close');
});
...
function loadBxzfyReqGrid(url) {
	...
	bxzfyReqDataGrid = $("#bztxDataGrid").datagrid({
		fit:true,
		stripe:true,
		singleSelect:true,
		rownumbers:true,
		...
		columns:[[
		  ...
		  {field:"systypename", title:"体系类型", halign:"center", width:250, sortable:true},
		  {field:"stagetypename", title:"阶段类型", halign:"center", width:150, sortable:true},
		  {field:"remark", title:"内容", halign:"center", width:150, sortable:true},
		  {field:"operator", title:"创建人", halign:"center", width:180, sortable:true},
		  {field:"opttime", title:"创建时间", halign:"center", width:180, sortable:true},
		  {field:"sysType", title:"体系类型", halign:"center", hidden:true, sortable:true },
		  {field:"stageType", title:"阶段类型", halign:"center", hidden:true, sortable:true}
        ]]
	});
}
