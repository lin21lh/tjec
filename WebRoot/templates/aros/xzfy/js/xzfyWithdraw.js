...
var base1 = contextpath + "aros/ajbg/fych/FychController/";

var Urls = {
	reqDetailUrl: base1 + "fychViewInit.do",                       
...
function xzfyReqDetail(){
	openxzfyDetail(Urls.reqDetailUrl, "案件撤回详情", 900, 550, "");
}
...
function fyWithdraw()
{
	...
	var fyWithdrawTable = $('#fyWithdrawTable');
	
	$("#fyWithdrawTable  tr:not(:first)").empty("");
...
function viewFlow(){
	...
	if(nodeid > 0 && nodeid != null){
		fyWithdraw();
		$('#draw_jd').css("background-color","#CCFF99");
