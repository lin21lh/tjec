...
var base1 = contextpath + "aros/ajbg/zzfy/ZzfyController/";

var Urls = {
	reqDetailUrl: base1 + "zzfyViewInit.do",                       
...
function xzfyReqDetail(){
	openxzfyDetail(Urls.reqDetailUrl, "案件终止详情", 900, 550, "");
}
...
function fyEnd()
{
	...
	var fyEndTable = $('#fyEndTable');
	
	$("#fyEndTable  tr:not(:first)").empty("");
...
function viewFlow(){
	...
	if(nodeid != null && nodeid >0){
		fyEnd();
		$('#end_jd').css("background-color","#CCFF99");
