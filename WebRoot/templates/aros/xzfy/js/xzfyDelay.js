...
var base1 = contextpath + "aros/ajbg/fyyq/FyyqController/";

var Urls = {
	reqDetailUrl: base1 + "fyyqViewInit.do",                       
...
function xzfyReqDetail(){
	openxzfyDetail(Urls.reqDetailUrl, "案件延期详情", 900, 550, "");
}
...
function fyDelay()
{
	...
	var fyDelayTable = $('#fyDelayTable');
	
	$("#fyDelayTable  tr:not(:first)").empty("");
...
function viewFlow(){
	...
	if(nodeid > 0 && nodeid != null ){
		fyDelay();
		$('#delay_jd').css("background-color","#CCFF99");
