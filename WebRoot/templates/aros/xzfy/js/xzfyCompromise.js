...
var base1 = contextpath + "aros/ajbg/fyhj/FyhjController/";

var Urls = {
	reqDetailUrl: base1 + "fyhjViewInit.do",                       
...
function xzfyReqDetail(){
	openxzfyDetail(Urls.reqDetailUrl, "案件和解详情", 900, 550, "");
}
...
// 复议和解
function fyCompromise()
{
	
	var fyCompromiseTable = $('#fyCompromiseTable');
	
	$("#fyCompromiseTable  tr:not(:first)").empty("");
...
function viewFlow(){
	...
	if(nodeid != null && nodeid > 0){
		fyCompromise();
		$('#cmprms_jd').css("background-color","#CCFF99");
