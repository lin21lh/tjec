...
var base1 = contextpath + "aros/ajbg/fytj/FytjController/";

var Urls = {
	reqDetailUrl: base1 + "fytjViewInit.do",                       
...
function xzfyReqDetail(){
	openxzfyDetail(Urls.reqDetailUrl, "案件调解详情", 900, 550, "");
}
...
function fyCompose()
{
	...
	var fyComposeTable = $('#fyComposeTable');
	
	$("#fyComposeTable  tr:not(:first)").empty("");
...
function viewFlow(){
	...
	if(nodeid != null || nodeid >0){
		fyCompose();
		$('#compose_jd').css("background-color","#CCFF99");
