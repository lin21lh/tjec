...
function selectUser(dialogId, type){
	...
	var href = contextpath + "aros/ysaj/controller/AdmlitbaseinfoController/selectUser.do";
...
function openUserDataGrid(dialog) {
	...
	var href = contextpath + "aros/ysaj/controller/AdmlitbaseinfoController/queryUserList.do";
