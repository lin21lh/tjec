...
var datagrid;
var urls = {
	queryUrl : baseUrl + "queryList.do?anaType=8",
 ...
 */
$(function() {	
	comboboxFuncByCondFilter(menuid, "startyear", "ANALYSISYEAR", "code", "name");// 
	$("#startyear").combobox("addClearBtn", {iconCls:"icon-clear"});
	comboboxFuncByCondFilter(menuid, "endyear", "ANALYSISYEAR", "code", "name");// 
...
function projectQuery() {
	var param = {
		...
		endyear : $("#endyear").combobox('getValues').join(","),
		menuid : menuid
	};
