...
var datagrid;
var urls = {
	queryUrl : baseUrl + "queryList.do?anaType=1",
...
$(function() {	
	...
	$("#anafrequency").combobox("addClearBtn", {iconCls:"icon-clear"});
	...
	$("#endyear").combobox("addClearBtn", {iconCls:"icon-clear"});
	
	comboboxFuncByCondFilter(menuid, "startmonth", "ANALYSISMONTH", "code", "name");// 职称
	$("#startmonth").combobox("addClearBtn", {iconCls:"icon-clear"});
	comboboxFuncByCondFilter(menuid, "endmonth", "ANALYSISMONTH", "code", "name");// 职称
	$("#endmonth").combobox("addClearBtn", {iconCls:"icon-clear"});
	
	comboboxFuncByCondFilter(menuid, "deftype", "B_CASEBASEINFO_DEFTYPE", "code", "name");// 职称
	...
	projectDataGrid = $("#projectDataGrid").datagrid({
		...
		columns : [ 
		            ...
		            [ 
		              ...
		              {	field : "e01",title : "维持",	halign : 'center',width : 100,sortable : true,styler:function(value,row,index){return 'background-color:#F0F0F0;';}},
		              {	field : "e02",title : "变更",	halign : 'center',width : 100,sortable : true,styler:function(value,row,index){return 'background-color:#F0F0F0;';}},
		              { field : "e03",title : "撤销",halign : 'center',	width : 100,sortable : true,styler:function(value,row,index){return 'background-color:#F0F0F0;';}}, 
		              {	field : "e04",title : "确认违法",	halign : 'center',width : 100,sortable : true,styler:function(value,row,index){return 'background-color:#F0F0F0;';}}, 
		              {	field : "e05",	title : "责令履行",	halign : 'center',width : 100,sortable : true,styler:function(value,row,index){return 'background-color:#F0F0F0;';}}, 
		              {	field : "casesum",title : "案件总数",halign : 'center',width : 100,sortable : true}, 
		              {	field : "amount",title : "赔偿金额（元）",	halign : 'center',width : 100,sortable : true}
		           ] 
		         ]
	});	
