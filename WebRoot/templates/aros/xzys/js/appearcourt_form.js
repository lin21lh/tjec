...
function loadFileDataGrid(url)
{
	fileDataGrid = $("#fileDataGrid").datagrid({
		...
		columns:[[ 
		  ...
		  {field:"filename", title:"附件名称", halign:"center", align:"left", width:250, sortable:true},
		  {field:"createtime",title:"上传时间", halign:"center",  align:"left", width:150, sortable:true},
