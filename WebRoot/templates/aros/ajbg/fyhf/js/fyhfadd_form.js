...
function choiseCase(){
	...
	parent.$.modalDialog2({
		...
		width:900,
		height:600,
		href:"aros/ajbg/fyhf/FyhfController/caseInit.do",
		onLoad:function() {},
		buttons : [{
				text : "确定",
				iconCls : "icon-save",
				handler : function() {
					...
					var suspendreason = selectRow[0].suspendreason;	
					var suspenddate = selectRow[0].suspenddate;	
					...
					parent.$.modalDialog.handler.find("#suspendreason").combobox("setValue", suspendreason);
					parent.$.modalDialog.handler.find("#suspenddate").datebox("setValue", suspenddate);
