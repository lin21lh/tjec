...
(function ($, undefined) {
    ...
    */
    ...
    function setMenuWidth(target, menu) {
        var opts = $.data(target, 'uxmenu').options;
    ...
    */
    function bindMenuItemEvent(target, item) {
        ...
        item.bind('click.menu', function () {
            ...
            $.data(target, 'uxmenu').options.onClick.call(target, item);
    ...
    */
    ...
    $.fn.uxmenu = function (options, param) {
        ...
        return this.each(function () {
            var state = $.data(this, 'uxmenu');
            if (state) {
                $.extend(state.options, options);
            } else {
                state = $.data(this, 'uxmenu', {
    ...
    $.fn.uxmenu.methods = {
        options: function (jq) {
            return $.data(jq[0], 'uxmenu').options;
        },
    ...
    $.fn.uxmenu.parseOptions = function (target) {
