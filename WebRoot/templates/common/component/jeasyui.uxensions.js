...
(function ($, undefined) {
   ...
   var winLoadError = null;
    ...
    var onLoadError = function (XMLHttpRequest, textStatus, errorThrown) {
        ...
        winLoadError = $.easyui.messager.alert("错误提醒", msg, "error", function() {winLoadError = null;});
//        var opts = winLoadError.window("options"), panel = winLoadError.window("panel"), width = panel.outerWidth(), height = panel.outerHeight();
//        if (width > 800 || height > 800) { winLoadError.window("resize", { width: width > 800 ? 800 : width, height: height > 800 ? 800 : height }); }
//        winLoadError.window("center");
    };
