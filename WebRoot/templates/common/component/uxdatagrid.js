...
(function ($, undefined) {
  ...
  //  var columnMoving = function(jq) {}
    ...
    function parseRowBaseContextMenuItems(t, opts, exts, e, rowIndex, rowData, eventData) {
        ...
        if (typeof exp == "object") { exp = $.extend({ current: false, all: false, submenu: true }, exp); }
        var m1 = {
            text: "刷新", iconCls: "pagination-load", disabled: !opts.refreshMenu,
...
//    }
    ...
    var methods = $.fn.datagrid.extensions.methods = {
       ...
       // beginEdit: function (jq, index) { return jq.each(function () { beginEdit(this, index); }); },
        ...
        //扩展 easyui-datagrid的自定义方法；
       // columnMoving : function (jq) { return jq.each(function() {columnMoving(this); }); },
    ...
    var defaults = $.fn.datagrid.extensions.defaults = {
        ...
        //      当右键单击行数据时选择右键当前单击的行的功能，默认为 false；
        ...
        //          submenu:    表示这四个菜单项是否以子菜单方式呈现，默认为 true；
        //  备注：当 enableRowContextMenu 属性设置为 true 时，该属性才有效。
        pagingMenu: false,//{ submenu: false },
    ...
    $.fn.datagrid.extensions.columnOptions = {
        tooltip: false,
        filterable: true,
        hidable: true,
        filter: "checkbox",
...
$.extend($.fn.datagrid.methods,{
    ...
    doCellTip:function (jq, params) {  
        function showTip(showParams, td, e, dg) {      
            ...
            showParams.content = '<div class="tipcontent">' + showParams.content.replaceAll('\n', '<br>'); + '</div>';      
            $(td).tooltip({      
