...
var urls = {
	...
	projectAuditUrl : baseUrl + "auditEntryForFgw.do",
	auditWorkFlow : baseUrl + "sendWorkFlow.do",
...
function loadProjectGrid(url) {
	projectDataGrid = $("#projectDataGrid").datagrid({
        ...
        ,{field : "zfzyzcMc",title : "政府资源支出",halign : 'center',	width:100,sortable:true ,hidden:true	}
       ] ]
	});
}
/**
...
function submitForm(url,form,workflowflag){
	...
	//最后节点，用于后台处理
	parent.$.modalDialog.handler.find("#lastNode").val("true");
